defmodule ReportServerWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: ReportServerWeb.Layouts]
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {ReportServerWeb.Layouts, :app}
  ...
  defp html_helpers do
    quote do
      ...
      # custom helpers
      import ReportServerWeb.Helpers
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: ReportServerWeb.Router,
        statics: ReportServerWeb.static_paths()
    end
  end
