defmodule ReportServer.Reports.Report do
  ...
  defstruct type: nil, slug: nil, title: nil, subtitle: nil, include_filters: [], get_query: nil, parents: [], path: nil, tbd: false, form_options: [], api_report_type: nil, derives_learner_data: true
