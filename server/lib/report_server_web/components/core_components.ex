defmodule ReportServerWeb.CoreComponents do
  @moduledoc """
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 rounded-lg bg-orange hover:bg-orange-light py-2 px-3",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ReportServerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ReportServerWeb.Gettext, "errors", msg, opts)
    end
  end
