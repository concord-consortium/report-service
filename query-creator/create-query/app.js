...
const learnersReport = async (params, body, tokenServiceEnv, debugSQL, reportServiceSource) => {
  ...
  // currently this value is a string in the params generated by the portal but this ensures it it changes to a boolean this won't break
  const hideNames = query.hide_names === "true" || query.hide_names === true;
  ...
  const doLearnerAnswerReporting = async () => {
    ...
    const sql = aws.generateSQL(runnableInfo, usageReport, authDomain, reportServiceSource, hideNames);
