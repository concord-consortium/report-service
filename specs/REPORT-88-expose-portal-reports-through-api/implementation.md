...
- **download empty**: stub yields only zero-row envelopes; assert a header-only 200 body (matching the now-corrected web encoder; see the shared-encoder step, which also adds the LiveView empty-download test).
